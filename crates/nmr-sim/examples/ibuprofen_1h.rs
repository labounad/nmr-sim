...
fn main() {
    ...
    let definitions = vec![
        PeakDef { // (CH3)2 — 6H, doublet
            shift: 0.90, area: 6.0, linewidth,
            couplings: vec![Coupling { j_hz: 6.6, n_neighbors: 1 }],
        },
        PeakDef { // CH3 on α-carbon — 3H, doublet
            shift: 1.52, area: 3.0, linewidth,
            couplings: vec![Coupling { j_hz: 7.1, n_neighbors: 1 }],
        },
        PeakDef { // CH (isopropyl) — 1H, septet
            shift: 1.85, area: 1.0, linewidth,
            couplings: vec![Coupling { j_hz: 6.6, n_neighbors: 6 }],
        },
        PeakDef { // CH2 benzylic — 2H, doublet
            shift: 2.47, area: 2.0, linewidth,
            couplings: vec![Coupling { j_hz: 7.2, n_neighbors: 1 }],
        },
        PeakDef { // CH (α) — 1H, quartet
            shift: 3.72, area: 1.0, linewidth,
            couplings: vec![Coupling { j_hz: 7.1, n_neighbors: 3 }],
        },
        PeakDef { // aromatic — 2H, triplet
            shift: 7.12, area: 2.0, linewidth,
            couplings: vec![Coupling { j_hz: 8.0, n_neighbors: 2 }],
        },
        PeakDef { // aromatic — 2H, triplet
            shift: 7.24, area: 2.0, linewidth,
            couplings: vec![Coupling { j_hz: 8.0, n_neighbors: 2 }],
        },
    ];
